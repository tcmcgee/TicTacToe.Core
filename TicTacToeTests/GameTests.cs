...
namespace TicTacToeTests
{
    public class GameTests
    {
        ...
        public void TurnTest()
        {
            Game game = new Game(9);
            string[] gameBoard = { "X", null, null, null, null, null, null, null, null };
            game.IO = new MockedIO(new MockedInput("1"), new MockedOutput());
            game.Turn();
        ...
        public void IsHorizontalWinXTest()
        {
            ...
            game.IO = new MockedIO(new MockedInput("3"), new MockedOutput());
            game.Turn();
        ...
        public void IsNotHorizontalWinTest()
        {
            ...
            game.board.SetBoard(gameBoard);
            game.IO = new MockedIO(new MockedInput("9"), new MockedOutput());
            game.Turn();
        ...
        {
            Game game = new Game(9);
            game.IO = new MockedIO(new MockedInput("2"), new MockedOutput());
            game.Turn();
